...
fun AddServerScreen(navController: NavController, appViewModel: AppViewModel) {
    ...
    fun validateNickname(text: String) {
        nicknameTextIsErr = text.isEmpty() and text.isBlank() and (text.length < 3)
    }
            ...
            Box(modifier = Modifier.padding(paddingValues)) {
                Column(
                    ...
                    OutlinedTextField(
                        ...
                        modifier = Modifier.focusRequester(requester2).fillMaxWidth(),
                    )
                    Spacer(modifier = Modifier.padding(8.dp))
                    OutlinedTextField(
                        value = textFields[2],
                        ...
                        modifier = Modifier.focusRequester(requester3).fillMaxWidth(),
                    )
                }
            }
        }
...
private fun onDone(
    ...
    textFields: List<TextFieldValue>
) {
